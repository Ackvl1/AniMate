...
from animate.core.engine.graph import Graph, GraphEngine, EventEmitter
from animate.core.engine.context import RunContext
from animate.core.engine.node import NodeResult, AgentEvent
from animate.core.agent.nodes import ReactNode, AfterNode, ReflectNode
...
from animate.core.log import setup_logger, ChatLogDB
...
class Agent:
    """AniMate 内核门面。使用图引擎驱动 4-Phase Pipeline。
    ...
    def create_default(
        ...
        try:
            from animate.core.tools.defaults import register_default_tools
