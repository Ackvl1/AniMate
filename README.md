# Anima Agent · 通用 AI Agent 框架

> **五层架构** · 通用 Agent 框架 · BSP 图引擎 · 真流式输出 · 11+ 工具 · RAG 双路检索 · HITL 权限 · 情绪系统 · 信任分 · 角色人格皮肤 · TTS · 3D 渲染
>
...
Anima Agent 是一个通用 AI Agent 框架，采用五层架构设计，通过 BSP 图引擎驱动的多节点流水线，将大语言模型（LLM）与工具系统、记忆系统、RAG 知识库深度集成。框架支持「角色人格皮肤」系统，可配置不同角色人设，实现从通用助手到深度角色扮演的灵活切换。
